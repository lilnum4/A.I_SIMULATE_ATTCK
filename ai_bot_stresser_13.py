# ai_bot_stresser_9_fixed.py - FIXED VERSION
...
class SimplifiedStresserGUI:
    ...
    def __init__(self, root):
        ...
        # Start C2 server automatically
        self.start_c2_server()
        self.update_status("Application started - C2 server is running")
